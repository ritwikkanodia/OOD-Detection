...
os.makedirs("/home/duckie/ritwik/data/duckie_kitti_test_output", exist_ok=True)
...
for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
    ...
    # plt.savefig(
    #     f"/home/duckie/ritwik/data/output/{filename}.png",
    #     bbox_inches="tight",
    #     pad_inches=0.0,
    # )
    # plt.close()
    #     print(bbox_coords)
    with open(f"/home/duckie/ritwik/data/output/{filename}.txt", "w") as f:
        f.write("\n".join(bbox_coords))
